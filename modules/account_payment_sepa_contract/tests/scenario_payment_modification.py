...
def check_exception(wiz):
    # #Comment# Here We want to raise an error because mixing multiple invalid
    # #Comment# lines with differents  banks / sepa mandates / payers
    try:
        wiz.execute('check')
    except Exception:
        return True
...
# #Comment# # Now the invoice whitout mandate should have the right one
# #Comment# # And the other invoice must not have been modified
