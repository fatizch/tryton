...
# #Title# #Payment Clearing Amount Scenario
# #Comment# #Imports
import datetime
...
# #Comment# #Install account_payment_clearing and account_statement
...
# #Comment# #Create another payable move
Move = Model.get('account.move')
move2 = Move()
