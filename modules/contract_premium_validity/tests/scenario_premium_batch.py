...
# #Comment# #Rule context
rule_context = RuleEngineContext(1)

# #Comment# #Termination rule
...
# #Comment# #Create Premium Ending Rule
end_rule = RuleEngine()
end_rule.algorithm = (
...
# #Comment# #Create Product Premium Date
...
contract.premium_validity_end
# #Res# #datetime.date(2014, 6, 30)
len(contract.all_premiums)
# #Res# #3

contract.all_premiums[-1].start
# #Res# #datetime.date(2014, 6, 1)
contract.all_premiums[-1].end
# #Res# #datetime.date(2014, 6, 30)
contract.all_premiums[-2].start
# #Res# #datetime.date(2014, 5, 1)
