...
# #Comment# #Let's suspend the contract five days later
...
# #Comment# #And restart it again 5 days afterwards
...
# #Comment# #Test the merging of periods by holding and unholding
...
# #Comment# #Let's void the contract
